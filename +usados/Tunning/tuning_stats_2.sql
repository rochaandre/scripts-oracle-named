REM EXCEPT WHERE EXPRESSLY PROVIDED OTHERWISE, THE INFORMATION, SOFTWARE,
REM PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS. ORACLE EXPRESSLY DISCLAIMS
REM ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT
REM LIMITED TO, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR
REM PURPOSE AND NON-INFRINGEMENT. ORACLE MAKES NO WARRANTY THAT: (A) THE RESULTS
REM THAT MAY BE OBTAINED FROM THE USE OF THE SOFTWARE WILL BE ACCURATE OR
REM RELIABLE; OR (B) THE INFORMATION, OR OTHER MATERIAL OBTAINED WILL MEET YOUR
REM EXPECTATIONS. ANY CONTENT, MATERIALS, INFORMATION OR SOFTWARE DOWNLOADED OR
REM OTHERWISE OBTAINED IS DONE AT YOUR OWN DISCRETION AND RISK. ORACLE SHALL HAVE
REM NO RESPONSIBILITY FOR ANY DAMAGE TO YOUR COMPUTER SYSTEM OR LOSS OF DATA THAT
REM RESULTS FROM THE DOWNLOAD OF ANY CONTENT, MATERIALS, INFORMATION OR SOFTWARE.
REM 
REM ORACLE RESERVES THE RIGHT TO MAKE CHANGES OR UPDATES TO THE SOFTWARE AT ANY
REM TIME WITHOUT NOTICE.
REM  
REM  
REM Limitation of Liability  
REM IN NO EVENT SHALL ORACLE BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL,
REM SPECIAL OR CONSEQUENTIAL DAMAGES, OR DAMAGES FOR LOSS OF PROFITS, REVENUE,
REM DATA OR USE, INCURRED BY YOU OR ANY THIRD PARTY, WHETHER IN AN ACTION IN
REM CONTRACT OR TORT, ARISING FROM YOUR ACCESS TO, OR USE OF, THE SOFTWARE.
REM 
REM SOME JURISDICTIONS DO NOT ALLOW THE LIMITATION OR EXCLUSION OF LIABILITY.
REM ACCORDINGLY, SOME OF THE ABOVE LIMITATIONS MAY NOT APPLY TO YOU.
REM  
REM   
REM  
REM  Abstract  
REM The script does a performance healthcheck on the system and makes suggestions on modifications that can be made if specific conditions exist. 
REM  
REM Product Name, Product Version Oracle Server - Enterprise Edition 7.X - 9.2.X 
REM Platform  Platform Independent 
REM Date Created  05-Nov-2002 
REM  
REM Instructions  
REM Execution Environment:
REM      <SQL, SQL*Plus, iSQL*Plus>
REM 
REM Access Privileges:
REM      Requires sysdba role.
REM 
REM Usage:
REM      sqlplus <user>/<pw> @[SCRIPTFILE]
REM 
REM PROOFREAD THIS SCRIPT BEFORE USING IT! Due to differences in the way text 
...
REM this type are corrected.The script will produce an output file named tuning_stats.txt.
REM This file can be viewed in a browser or uploaded for support analysis.
REM  
REM  
REM Description  
REM The script does a performance healthchek on the instance and database 
REM and makes suggestions on modifications that can be made if specific conditions exist.
