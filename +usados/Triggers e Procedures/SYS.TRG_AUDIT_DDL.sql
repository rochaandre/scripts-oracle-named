...
DDL ON DATABASE begin
  ...
  SendorAddress    varchar2(30) := 'HMCOLL@vesper.com.br';
  ReceiverAddress  varchar2(30) := 'abarcelos@vesper.com.br';
  ReceiverAddress2 varchar2(30) := 'abarcelos@vesper.com.br';
...
--         end if;
        ...
        if v_osuser in ('abarc_','smero','oracle8') or ora_login_user  is null then
          raise_application_error(-20001, '*****>>> Atenção! Voce executou um procedimento não permitido. Enviando e_mail automático para a Diretoria da Embratel/Vésper...  *****');
     ...
     --   when send_mail then
      --DBMS_OUTPUT.PUT_LINE
        --   ('Atenção! Voce executou um procedimento não permitido. Enviando e_mail para a Diretoria da Embratel/Vésper');           
        --    close cs_Rec;
