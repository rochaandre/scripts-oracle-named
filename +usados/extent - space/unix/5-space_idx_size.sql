/*
 *  Index space utilization Report.
 */
...
spool c:\space_idx_size.log
column name noprint new_value dbname
select name from v$database;

ttitle left "Database: "dbname" - Index segment utilization Report" skip 2 


select a.tablespace_name,a.segment_name,b.max_extents,a.extents,
